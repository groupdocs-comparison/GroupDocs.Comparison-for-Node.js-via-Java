 ...
 */
async function compareMultipleDocumentsProtectedPath(
  groupdocs,
  source,
  targets,
  sourcePassword,
  ...
  const exampleName = 'compareMultipleDocumentsProtectedPath';

  console.log('\n================================================================================');
  console.log('Running Example: compareMultipleDocumentsProtectedPath');
  console.log('Description: Compare multiple password-protected documents');
  console.log('================================================================================\n');
  ...
  try {
    ...
    targets.forEach((targetPath) => {
      comparer.add(targetPath, new groupdocs.LoadOptions(targetPassword));
    });
    ...
    console.error('\n✗ Error in compareMultipleDocumentsProtectedPath:', error.message);
    console.error(error);
    throw error;
  }
}
